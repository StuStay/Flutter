...
import 'package:responsive_admin_dashboard/data/dataP.dart';

import 'analytic_info_cardP.dart';

class AnalyticCardsP extends StatelessWidget {
  const AnalyticCardsP({Key? key}) : super(key: key);
