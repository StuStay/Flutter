...
class DiscussionInfoDetailReservation extends StatelessWidget {
  const DiscussionInfoDetailReservation({Key? key, required this.info}) : super(key: key);

  final DiscussionInfoModelr info;
