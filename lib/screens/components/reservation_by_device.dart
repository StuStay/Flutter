...
class ReservationByDevice extends StatefulWidget {
  ...
  @override
  _ReservationByDeviceState createState() => _ReservationByDeviceState();
}

class _ReservationByDeviceState extends State<ReservationByDevice> {
  ...
  Future<void> fetchData() async {
    ...
    if (response.statusCode == 200) {
      try {
        ...
        setState(() {
          dishwasherPercentage = totalReservations > 0
              ? dishwasherReservations / totalReservations
              : 0.0;
        });
      } catch (e) {
